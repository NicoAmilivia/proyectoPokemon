...
public class EntrenamientoController {
    ...
    private void cambiarPokemonOnAction(){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/es/cesur/progprojectpok/view/elegirPokemonEntrenamiento-view.fxml"));
            Scene scene = new Scene(fxmlLoader.load(), 590, 600);
            ElegirPokemonEntrenamientoController elegirPokemonEntrenamientoController = fxmlLoader.getController();
            elegirPokemonEntrenamientoController.setEntrenamientoController(this);
